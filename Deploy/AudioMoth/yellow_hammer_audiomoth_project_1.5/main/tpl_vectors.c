...
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_DMA_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));
extern FUNC(void, OS_CODE) tpl_primary_irq_handler_RTC_IRQ(P2CONST(void, OS_APPL_DATA, AUTOMATIC));

/* Interrupt table vector */

__attribute__ ((section(".isr_vector"))) CONST(tpl_it_handler, AUTOMATIC) tpl_it_vectors[54] = {
  ...
  (tpl_it_handler)tpl_primary_irq_handler_DMA_IRQ,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  ...
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_primary_irq_handler_RTC_IRQ,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
  (tpl_it_handler)tpl_null_it,
