...
DeclareTask(copyDMAtoSRAM);
DeclareTask(inference);
DeclareTask(setup_inference);
DeclareTask(start_audio);
DeclareTask(start_dma);
DeclareTask(start_sdcard);
DeclareTask(write_audio);
DeclareEvent(ev_DMAtoSRAM);
DeclareEvent(ev_NORMALIZE);
DeclareEvent(ev_write_audio);
